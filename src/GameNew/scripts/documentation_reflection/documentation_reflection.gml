function Documentation_Reflection() {
	/*
	...
	**USAGE**---------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	Arguments:
		...
		Layer: This is the instance layer where the reflections will be drawn. Can be the "layer name" or the layer ID.
	...
	**ENABLE REFLECTIONS FOR OBJECTS**---------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	Use refl_add_object() to add an object that should be reflected. It can be an instance ID or an object.
	...
	**IMPORTANT**---------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	-----
	If the reflection is not being drawn for an object, make sure its sprite's alpha is not below 1 (full alpha), because it won't work with transparent pixels.
