function draw_sprite_tiled_area(sprite, subimg, x0, y0, x1, y1, x2, y2){
...
/// GMLscripts.com/license
{
    ...
    i = x1-((x1 mod sw) - (x0 mod sw)) - sw*((x1 mod sw)<(x0 mod sw));
    j = y1-((y1 mod sh) - (y0 mod sh)) - sh*((y1 mod sh)<(y0 mod sh)); 
    jj = j;
