function scr_daycycle_smooth_transition(hour, weath, rate){
	switch weath{
		#region Sun
		case weather.sun:
			switch hour{
				case 0:
					color[hour,0] = approach_fixed(color[hour,0], 030/255, rate);
					color[hour,1] = approach_fixed(color[hour,1], 100/255, rate);
					color[hour,2] = approach_fixed(color[hour,2], 230/255, rate);

					con_sat_brt[hour,0] = approach_fixed(con_sat_brt[hour,0], 0.30, rate);
					con_sat_brt[hour,1] = approach_fixed(con_sat_brt[hour,1], 0.90, rate);
					con_sat_brt[hour,2] = approach_fixed(con_sat_brt[hour,2], -0.45, rate);

					con_sat_brt[hour,3] = approach_fixed(con_sat_brt[hour,3], 0.70, rate);
					con_sat_brt[hour,4] = approach_fixed(con_sat_brt[hour,4], 0.65, rate);
				break;
				case 1:
					color[hour,0] = approach_fixed(color[hour,0], 030/255, rate);
					color[hour,1] = approach_fixed(color[hour,1], 100/255, rate);
		...
		case weather.few_clouds:
			switch hour{
				case 0:
					color[hour,0] = approach_fixed(color[hour,0], 035/255, rate);
					color[hour,1] = approach_fixed(color[hour,1], 105/255, rate);
					color[hour,2] = approach_fixed(color[hour,2], 250/255, rate);

					con_sat_brt[hour,0] = approach_fixed(con_sat_brt[hour,0], 0.30, rate);
					con_sat_brt[hour,1] = approach_fixed(con_sat_brt[hour,1], 0.90, rate);
					con_sat_brt[hour,2] = approach_fixed(con_sat_brt[hour,2], -0.65, rate);
