function draw_circle_segment(x, y, value, max, colour, radius, transparency){

	if (value > 0) { // no point even running if there is nothing to display (also stops /0
	    var i, len, tx, ty, val;
    
	    var numberofsections = 360; // there is no draw_get_circle_precision() else I would use that here
