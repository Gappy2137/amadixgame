...
if (wtr){
	...
	draw_sprite_ext(spr_entity_water_shallow, (obj_gamecontrol.refTimer * 4), x, y + _height - 35.5, 1, 1, 0, c_white, .75);
	...
	draw_sprite_ext(spr_entity_wateredge, 0, x, y + _height - 35.5, 1, 1, 0, c_white, 1);
